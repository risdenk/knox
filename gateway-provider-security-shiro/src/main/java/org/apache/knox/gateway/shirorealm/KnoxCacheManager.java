...
/**
 * Copied from {@link org.apache.shiro.cache.ehcache.EhCacheManager} to override getCache
 */
public class KnoxCacheManager implements CacheManager, Initializable, Destroyable {

  /**
   * This class's private log instance.
   */
  private static final Logger log = LoggerFactory.getLogger(KnoxCacheManager.class);
  ...
  public final <K, V> Cache<K, V> getCache(String name) throws CacheException {
    ...
    try {
      Ehcache cache = ensureCacheManager().getEhcache(name);
      if (cache == null) {
      ...
      return new EhCache<K, V>(InstrumentedEhcache.instrument(registry, cache));
