...
public class DefaultConnectionManagerBuilder implements ConnectionManagerBuilder {
  ...
  public PoolingHttpClientConnectionManager build() {
    return new PoolingHttpClientConnectionManager(getConnectionSocketFactoryRegistry());
  }
