...
import org.apache.knox.gateway.shell.hbase.table.scanner.stateless.ScannerStateless;
...
public class Scanner {
  ...
  public ScannerStateless stateless() {
    return new ScannerStateless(table.session(), table.name());
  }
}
